...
import blogs from '../../assets/logo-blog.jpg'
    ...
    return (
      <div className={`post-item bg-white ${props.className}`}>
        <div className={"author-post"}>
          <Avatar src={blogs} size={40} />
          <div className="author-time">
            <span className="author">Users</span>
        ...
        <div className={"content-post"}>
          ...
          <div className="images">
            <img
              src={"https://paradisewildhills.com/assets/img/slide/wild-s4.jpg"}
        ...
        <div className="interact">
          ...
          <div className="item-interact">
            <MessageIcon className={`message-icon`} />2
          </div>
        ...
        <div className="list-comment">
          ...
          <div className="view-more">Xem tất cả bình luận</div>
        </div>
      </div>
    );
}
